  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-800 py-2 px-4 md:hidden z-50">
      <div className="flex justify-between items-center">
        ...
        <Link href="/tickets" className="flex flex-col items-center text-gray-400 hover:text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="none"
        ...
        <Link href="/saved" className="flex flex-col items-center text-gray-400 hover:text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="none"
